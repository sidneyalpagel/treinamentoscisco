...
@section('conteudo')
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-bold text-slate-800">Nova área / setor</h1>
    </div>
    <form method="POST" action="{{ route('gestao.areas.store') }}">
        @csrf
        @include('gestao.areas._form', ['textoBotao' => 'Cadastrar área'])
    </form>
@endsection
